        ...
        <style>
          * {
          ...
          .content {
            ...
            padding: 40px 70px;
            border-radius: 5px;
            box-shadow: 0px 2px 11px 0px #b0c4deb0;
            text-align: justify;
            margin-bottom: 50px;
            font-weight: 400;
            font-size: 14px;
          ...
          <tr>
            <td align="center">
              ...
              >
                ...
                <tr>
                  <td class="content">
                    <h2 class="fw-600" style="font-size: 18px">
                      Dear ${user.firstName},
                    </h2>
                    <p>
                      We are writing to inform you about an important security
                      update to your
                      <span class="fw-600">PRMS Reporting Tool</span> account.
                    </p>
                    <p>
                      As part of our ongoing commitment to security and user
                      experience, we have migrated our authentication system to a
                      new, more secure platform. This migration requires all users
                      to set up a new password.
                    </p>
                    <div class="password-box">
                      <p class="fw-600" style="margin: 0">
                        Your temporary password is:
                      </p>
                      <p class="password">${tempPassword}</p>
                    </div>
                    <div class="warning">
                      <p class="fw-600" style="margin-top: 0">
                      ...
                      <ul style="margin: 0; padding-left: 20px">
                        ...
                        <li>
                          You will be required to create a new password immediately
                        </li>
                    ...
                    <div class="steps">
                      ...
                      <ol style="margin: 0; padding-left: 20px">
                        ...
                        <li class="step-item">
                          Follow the password requirements to create your new secure password
                        </li>
                      </ol>
                    </div>
                    <p>
                      If you experience any issues during this process, please
                      contact our support team at
                      <a href="mailto:PRMSTechSupport@cgiar.org" class="link fw-600"
                        >PRMSTechSupport@cgiar.org</a
                      >
                    </p>
                    <p>
                ...
                <tr>
                  <td class="footer">
                    <p>
                      This is an automated security notification. You are receiving
                      this email because you are registered in the PRMS Reporting
                      Tool. For security reasons, this message cannot be replied to.
                    </p>
